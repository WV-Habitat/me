...
- Simple model -> analytically tractable -> transient dynamics
- Matrix algebra, Jacobian approximation
...
- Non-linear hierachical Bayesian models
...
- [Manuscript template](https://github.com/willvieira/ms_STM-managed) (using markdown, LaTeX, Pandoc, Lua and yaml)
- [Presentation template](https://github.com/willvieira/talkTemplate) (this presentation, some CSS and JavaScript)
- Books (Lab notebook, ECCC report)
...
1. Optimal GeoTIFF storage (store and organize each pixel information)
  - Tiling
  - Overviews
2. HTTP GET range requests (extract only a portion of the GeoTIFF file)

--

.font120[**STAC catalog**]
- 
- 